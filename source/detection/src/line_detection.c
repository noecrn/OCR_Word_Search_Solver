...
#define WHITE_THRESHOLD                                                        \
  0 // Minimum number of black pixels to consider a block as black
#define SPACE_THRESHOLD                                                        \
  0 // Minimum number of consecutive white blocks to consider a gap
...
int detect_columns(SDL_Surface *surface, int left_bound, int right_bound,
  ...
  int in_black_column =
      0; // Indicator to know if we are in a column with black pixels
...
int detect_rows(SDL_Surface *surface, int left_bound, int right_bound,
  ...
  int in_black_row =
      0; // Indicator to know if we are in a row with black pixels
